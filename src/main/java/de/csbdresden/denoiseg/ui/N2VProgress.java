...
public class N2VProgress extends JPanel {
	...
	private DenoiSegTraining n2v;
	private N2VChartPanel chart;
	private JLabel warningLabel;

	public N2VProgress(JFrame frame, DenoiSegTraining n2v, int nEpochs, int nEpochSteps, StatusService status, ThreadService threadService ) {
	...
	public static N2VProgress create(DenoiSegTraining n2v, int nEpochs, int nEpochSteps, StatusService status, ThreadService threadService ) {
